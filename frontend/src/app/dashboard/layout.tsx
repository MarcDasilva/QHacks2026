        ...
        <div className="flex flex-1 flex-col">
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-1 gap-4 overflow-hidden px-4 py-4 md:px-6 md:py-6">
              <div className="min-h-[200px] min-w-0 flex-1 overflow-auto">
                {children}
              </div>
              <div className="flex min-h-[280px] w-80 shrink-0 flex-col overflow-hidden rounded-xl bg-zinc-200 dark:bg-zinc-800 md:w-96">
                <BoohooRive />
              </div>
            </div>
          </div>
